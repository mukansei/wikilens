...
> **비용 모델도 쟀습니다**(2026-08-28) — 오답 시 `1+n=9` 읽기를 가정했는데 실측은
> **중앙값 1**입니다(34세션, 후보 8개를 다 읽는 세션은 없었습니다). 오답이 거의
> 공짜라 문턱은 더 느슨해집니다. **남는 관문은 발동 여부 하나입니다** —
> [판정 기준](docs/design/design-2026-08-28-1x-gate.md) ·
> [실측](docs/experiment-2026-08-28-cost-model.md).
